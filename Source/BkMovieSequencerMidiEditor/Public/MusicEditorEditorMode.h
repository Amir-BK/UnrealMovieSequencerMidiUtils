...
#include "MusicEditorEditorMode.generated.h"
 ...
 */
UCLASS()
class UMusicEditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_MusicEditorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UMusicEditorEditorMode();
	virtual ~UMusicEditorEditorMode();
