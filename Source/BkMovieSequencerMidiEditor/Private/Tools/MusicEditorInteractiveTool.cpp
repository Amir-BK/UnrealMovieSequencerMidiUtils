...
#include "MusicEditorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UMusicEditorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UMusicEditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UMusicEditorInteractiveTool* NewTool = NewObject<UMusicEditorInteractiveTool>(SceneState.ToolManager);
...
UMusicEditorInteractiveToolProperties::UMusicEditorInteractiveToolProperties()
{
...
void UMusicEditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UMusicEditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UMusicEditorInteractiveToolProperties>(this, "Measurement");
...
void UMusicEditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UMusicEditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UMusicEditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UMusicEditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UMusicEditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UMusicEditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UMusicEditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UMusicEditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UMusicEditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
