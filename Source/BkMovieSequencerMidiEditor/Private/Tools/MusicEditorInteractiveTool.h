...
#include "MusicEditorInteractiveTool.generated.h"


/**
 * Builder for UMusicEditorInteractiveTool
 */
UCLASS()
class BKMOVIESEQUENCERMIDIEDITOR_API UMusicEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UMusicEditorInteractiveTool
 */
UCLASS(Transient)
class BKMOVIESEQUENCERMIDIEDITOR_API UMusicEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UMusicEditorInteractiveToolProperties();
...
/**
 * UMusicEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class BKMOVIESEQUENCERMIDIEDITOR_API UMusicEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UMusicEditorInteractiveToolProperties> Properties;
